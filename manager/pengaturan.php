<?php
 ...
 $sql = "SELECT * FROM manager WHERE id_mng='$sess_mngid'";
	...
	if(isset($_POST['update'])) {
		...
		if($password_old == $password_old2) {
			if($password_new == $password_new2) {
				$sql = "UPDATE manager SET password='". $password_new ."' WHERE id_mng='". $id_pengguna ."'";
				$ress = mysqli_query($conn, $sql);
					...
					<div class="col-lg-12 col-md-12">										
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<input type="hidden" name="id_pengguna" value="<?php echo $data['id_mng'] ?>">
							</div>
						</div>
						<div class="form-group row">
